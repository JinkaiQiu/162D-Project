...
lower_brown = np.array([0, 0, 0])     # Poop的HSV阈值下限
upper_brown = np.array([40, 225, 200])  # Poop的HSV阈值上限
...
def main(args=None):                                                              # ROS2节点主入口main函数
    ...
    image = cv2.imread('src/Detect_Poop/learning_node/learning_node/poop1.png')  # 读取图像
